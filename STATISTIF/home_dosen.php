...
<head>
	...
	<link rel="stylesheet" type="text/css" href="homedosen.css">
...
<body>
	...
	<section>
		...
		<div class="descvote">Berbagai tampilan data yang dirangkum dari hasil voting.</div>
	<div class="container">
		<div class="card">
			<img class="image" src="img/comingsoon.png">	
		</div>
		<div class="card">
			<a href="#"><img class="image" src="img/vdosen.png"></a>	
		</div>
		<div class="card">
			<img class="image" src="img/vmk.png">		
		</div>
	</div>
